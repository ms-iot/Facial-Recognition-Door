...
namespace Microsoft.ProjectOxford.Face
{
    ...
    public class FaceServiceClient : IFaceServiceClient
    {
        ...
        public async Task<Face[]> DetectAsync(string url, bool analyzesFaceLandmarks = false, bool analyzesAge = false, bool analyzesGender = false, bool analyzesHeadPose = false)
        {
            ...
            var requestBody = new URLReqestData(url);

            return await this.SendAsync<URLReqestData, Face[]>("POST", requestBody, request);
        }
        ...
        public async Task<VerifyResult> VerifyAsync(Guid faceId1, Guid faceId2)
        {
            ...
            var requestBody = new VerificationRequestData(faceId1, faceId2);

            return await this.SendAsync<VerificationRequestData, VerifyResult>("POST", requestBody, request);
        }
        ...
        public async Task<IdentifyResult[]> IdentifyAsync(string personGroupId, Guid[] faceIds, int maxNumOfCandidatesReturned = 1)
        {
            ...
            var requestBody = new IdentificationRequestData(faceIds, personGroupId, maxNumOfCandidatesReturned);

            return await this.SendAsync<IdentificationRequestData, IdentifyResult[]>("POST", requestBody, request);
        }
        ...
        public async Task CreatePersonGroupAsync(string personGroupId, string name, string userData = null)
        {
            ...
            var requestBody = new PersonGroupReqeustData(name, userData);
       
            await this.SendAsync<PersonGroupReqeustData, PersonGroup>("PUT", requestBody, request);
        }
        ...
        public async Task UpdatePersonGroupAsync(string personGroupId, string name, string userData = null)
        {
            ...
            await this.SendAsync<PersonGroupReqeustData, PersonGroup>("PATCH", requestBody, request);
        }
        ...
        public async Task AddPersonFaceAsync(string personGroupId, Guid personId, Guid faceId, string userData = null)
        {
            ...
            var requestBody = new UserDataReqeustData(userData);

            await this.SendAsync<UserDataReqeustData, object>("PUT", requestBody, request);
        }
        ...
        public async Task UpdatePersonFaceAsync(string personGroupId, Guid personId, Guid faceId, string userData)
        {
            ...
            await this.SendAsync<UserDataReqeustData, object>("PATCH", requestBody, request);
        }
        ...
        public async Task<SimilarFace[]> FindSimilarAsync(Guid faceId, Guid[] faceIds)
        {
            ...
            var requestBody = new FindSimilarRequestData(faceId, faceIds);

            return await this.SendAsync<FindSimilarRequestData, SimilarFace[]>("POST", requestBody, request);
        }
        ...
        public async Task<GroupResult> GroupAsync(Guid[] faceIds)
        {
            ...
            var requestBody = new GroupFaceRequestData(faceIds);

            return await this.SendAsync<GroupFaceRequestData, GroupResult >("POST", requestBody, request);
        }
        #endregion
